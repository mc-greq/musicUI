...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:G:\\java\\intellij\\musicUi\\" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS = "SELECT " + COLUMN_ALBUM_ID + " FROM " +
    ...
    public void close() {
        try {
            ...
            closeResource(querySongInfoView);
            closeResource(insertIntoArtists);
            closeResource(insertIntoAlbums);
            closeResource(insertIntoSongs);
            closeResource(queryArtists);
            closeResource(queryAlbum);
            closeResource(queryAlbumsByArtistId);
            closeResource (conn);
    ...
    private void closeResource(AutoCloseable statement) throws Exception {
        if(statement != null){
            statement.close();
        }
    }
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder) {
        ...
        chooseSortType(sortOrder, sb, QUERY_ALBUMS_BY_ARTIST_SORT);
    ...
    private void chooseSortType(int sortOrder, StringBuilder sb, String queryAlbumsByArtistSort) {
        if (sortOrder != ORDER_BY_NONE) {
            sb.append(queryAlbumsByArtistSort);
            if (sortOrder == ORDER_BY_DESC) {
                sb.append("DESC");
            } else {
                sb.append("ASC");
    ...
    private int insertArtist(String name) throws SQLException{
        ...
        ResultSet result = queryArtists.executeQuery();
    ...
    public void insertSong(String title, String artist, String album, int track){
        try{
            ...
            try{
                ...
                System.out.println("Ouch! Things got really bad! " + e2.getMessage());
            }
            ...
            try{
                ...
                System.out.println("Couldnt reset autocommit!" + e.getMessage());
            }
